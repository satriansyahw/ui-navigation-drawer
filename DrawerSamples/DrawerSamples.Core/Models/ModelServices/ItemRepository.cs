...
namespace DrawerSamples.ModelServices
{
    ...
    public class ItemRepository : IItemRepository
    {
        ...
        private Item CreateItem(XElement x)
        {
            ...
            {
                item._thumbnailImage = System.Reflection.IntrospectionExtensions.GetTypeInfo(typeof(ItemRepository)).Assembly.GetManifestResourceStream("DrawerSamples.Core.Assets.Images.Thumbnail." + item.Image).ToByte();
                item._largeImage = System.Reflection.IntrospectionExtensions.GetTypeInfo(typeof(ItemRepository)).Assembly.GetManifestResourceStream("DrawerSamples.Core.Assets.Images.Large." + item.Image).ToByte();
            }
        ...
        public IEnumerable<Item> GetAll()
        {
            if (_items == null)
            {
                XDocument doc = XDocument.Load(System.Reflection.IntrospectionExtensions.GetTypeInfo(typeof(ItemRepository)).Assembly.GetManifestResourceStream("DrawerSamples.Core.Assets.Data.Inventories.xml"));
