    ...
    public class CategoryRepository : ICategoryRepository
    {
        ...
        private Category CreateCategory(XElement x)
        {
            ...
            if (!string.IsNullOrEmpty(category.Image))
                category.LargeImage = System.Reflection.IntrospectionExtensions.GetTypeInfo(typeof(ItemRepository)).Assembly.GetManifestResourceStream("DrawerSamples.Core.Assets.Images.Category." + category.Image).ToByte();
        ...
        public virtual IEnumerable<Category> GetAll()
        {
            if (_items == null)
            {
                XDocument doc = XDocument.Load(System.Reflection.IntrospectionExtensions.GetTypeInfo(typeof(CategoryRepository)).Assembly.GetManifestResourceStream("DrawerSamples.Core.Assets.Data.Categories.xml"));
