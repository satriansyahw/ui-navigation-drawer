...
namespace DrawerSamples.ModelServices
{
    ...
    public class ItemRepository : IItemRepository
    {
        ...
        private Item CreateItem(XElement x)
        {
            ...
            {
                item._thumbnailImage = typeof(ItemRepository).GetTypeInfo().Assembly.GetManifestResourceStream("DrawerSamples.Core.Assets.Images.Thumbnail." + item.Image).ToByte();
                item._largeImage = typeof(ItemRepository).GetTypeInfo().Assembly.GetManifestResourceStream("DrawerSamples.Core.Assets.Images.Large." + item.Image).ToByte();
            }
        ...
        public IEnumerable<Item> GetAll()
        {
            if (_items == null)
            {
                XDocument doc = XDocument.Load(typeof(ItemRepository).GetTypeInfo().Assembly.GetManifestResourceStream("DrawerSamples.Core.Assets.Data.Inventories.xml"));
